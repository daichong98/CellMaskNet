...
hovernet_path = workspace_root / "hovernet_segmentation"
...
def check_hovernet_setup():
    ...
    # Check model file
    model_path = hovernet_path / 'hovernet_model_weights.pth'  ###hovernet_model_weights
...
def process_pannuke_images():
    ...
    config = {
        'model_path': str(hovernet_path / 'hovernet_original_consep_notype_pytorch.pth'),
        'model_mode': 'original',
        'gpu': '0',
        'nr_types': '0',
